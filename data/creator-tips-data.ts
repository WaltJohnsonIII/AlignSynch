...
Before publishing, have someone else take your quiz to ensure the questions are clear and have the right level of difficulty.
  ...
  },
  {
    ...
    excerpt:
      "Discover proven methods to boost participation and keep users coming back to your quizzes.",
    content: `
...
Regularly update your quizzes and add new content to give users reasons to return.
  ...
  },
  {
    ...
    excerpt:
      "Learn different strategies to generate revenue from your quiz content.",
    content: `
...
Aggregate anonymized data from quizzes to provide valuable market insights to partners.
  ...
  },
  {
    ...
    excerpt:
      "Design principles that make your quizzes more effective and enjoyable for participants.",
    content: `
...
export function getRelatedTips(currentTip: Tip, count = 3) {
  return tips
    .filter(
      (tip) => tip.id !== currentTip.id && tip.category === currentTip.category
    )
    .slice(0, count);
}
