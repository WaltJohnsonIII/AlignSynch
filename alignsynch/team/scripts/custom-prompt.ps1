# Custom Multi-Line PowerShell Prompt
# Fixes cursor positioning and adds green accent
...
function prompt {
    ...
    # Create the info bar (first line)
    Write-Host ""
    Write-Host "╭─ " -NoNewline -ForegroundColor DarkGray
    Write-Host "jaden.black" -NoNewline -ForegroundColor Yellow
    Write-Host " " -NoNewline
    Write-Host "alignsynch" -NoNewline -ForegroundColor Magenta
    Write-Host " " -NoNewline
    ...
    # Create the input line (second line) with cursor
    Write-Host "╰─ " -NoNewline -ForegroundColor DarkGray
