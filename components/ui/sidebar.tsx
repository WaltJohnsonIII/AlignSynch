...
>(
  (
    ...
    return (
      <SidebarContext.Provider data-oid="kpwq-j0" value={contextValue}>
        <TooltipProvider data-oid="k4nzp:w" delayDuration={0}>
          <div
            className={cn(
    ...
    if (isMobile) {
      return (
        ...
        >
          ...
          >
            <div className="flex h-full w-full flex-col" data-oid=".1ws9d3">
              {children}
            </div>
          </SheetContent>
        </Sheet>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      data-oid="_yww:h7"
    >
      <PanelLeft data-oid="1y2nc97" />
      <span className="sr-only" data-oid="x0vu4:g">
        Toggle Sidebar
      </span>
    </Button>
  );
...
>(
  (
    ...
    return (
      <Tooltip data-oid="toqhthp">
        <TooltipTrigger asChild data-oid="23cfj_n">
          {button}
        </TooltipTrigger>
        <TooltipContent
          align="center"
...
const SidebarMenuSubItem = React.forwardRef<
  HTMLLIElement,
  React.ComponentProps<"li">
>(({ ...props }, ref) => <li ref={ref} {...props} data-oid="7afmfsl" />);
