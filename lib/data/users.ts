...
const users: User[] = [
  {
    ...
    createdQuizzes: [
      ...
      },
      {
        ...
        description:
          "Journey through time with this comprehensive history quiz!",
      ...
      },
      {
        ...
        description:
          "Compete with others in this annual science knowledge tournament!",
    ...
    achievements: [
      {
        ...
        name: "Quiz Creator",
        description:
          "Create 25 quizzes that have been played by at least 10 people",
        icon: "pencil",
        earnedAt: "2023-02-18",
        rarity: "rare",
      },
