...
export const notifications: Notification[] = [
  {
    ...
    time: "10m ago",
    icon: <Trophy className="h-5 w-5 text-yellow-500" data-oid="poa0hw1" />,
    read: false,
  ...
  },
  {
    ...
    time: "1h ago",
    icon: <Users className="h-5 w-5 text-blue-500" data-oid="n31lqc." />,
    read: false,
  ...
  },
  {
    ...
    time: "3h ago",
    icon: <Gift className="h-5 w-5 text-green-500" data-oid="z0m7at3" />,
    read: false,
    link: "/earnings",
  },
  {
    ...
    time: "5h ago",
    icon: <Calendar className="h-5 w-5 text-purple-500" data-oid="ukwam:y" />,
    read: true,
    link: "/tournaments",
  },
  {
    ...
    time: "1d ago",
    icon: <AlertCircle className="h-5 w-5 text-red-500" data-oid="bmkl2qm" />,
    read: true,
    link: "/create",
  },
  {
    ...
    time: "2d ago",
    icon: <Star className="h-5 w-5 text-amber-500" data-oid="_kvq4:3" />,
    read: true,
    link: "/my-quizzes",
  },
];
