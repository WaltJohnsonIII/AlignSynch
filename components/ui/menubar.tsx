...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className="ml-auto h-4 w-4" data-oid="y.w-6r_" />
  </MenubarPrimitive.SubTrigger>
));
...
>(
  (
    ...
    <MenubarPrimitive.Portal data-oid="dvtgq78">
...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <span
      ...
      data-oid="r-wpzlv"
    >
      <MenubarPrimitive.ItemIndicator data-oid="fgxs4xu">
        <Check className="h-4 w-4" data-oid="m63b122" />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span
      ...
      data-oid="gq1vrnp"
    >
      <MenubarPrimitive.ItemIndicator data-oid="2wx4rx3">
        <Circle className="h-2 w-2 fill-current" data-oid="fik3b9l" />
      </MenubarPrimitive.ItemIndicator>
    </span>
    {children}
  </MenubarPrimitive.RadioItem>
